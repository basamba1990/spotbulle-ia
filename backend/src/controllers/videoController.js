  ...
  getVideos: async (req, res) => {
    try {
      ...
      const { count, rows: videos } = await Video.findAndCountAll({
        ...
        attributes: [
          'id', 'user_id', 'titre', 'description', 'thematique', 'url_video',
          'url_thumbnail', 'duree', 'taille', 'date_upload', 'statut',
          'transcription', 'format', 'resolution', 'fps', 'vues', 'likes',
          'tags', 'metadonnees', 'parametres_confidentialite', 'date_modification'
        ]
      });
